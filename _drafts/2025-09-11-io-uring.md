...
I tried to `strace` the write tests. Sadly, using strace slows down the sync test significantly. This is most likely due to the strace overhead caused by the no. of syscalls. See [write strace(s)](#write-straces) below for the traces
